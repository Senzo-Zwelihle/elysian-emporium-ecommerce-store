...
const RippleEffect = ({ show }: { show: boolean }) => {
  ...
  return (
    <motion.div
      ...
      initial={{
        background:
          "radial-gradient(circle, rgba(239,68,68,0.3) 0%, transparent 0%)",
        scale: 0,
      }}
      animate={{
        background:
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          className="absolute inset-0 opacity-0 bg-gradient-to-r from-red-400 to-pink-400"
          animate={{
        ...
        {/* Ripple effect */}
        <AnimatePresence>
          {showRipple && <RippleEffect show={showRipple} />}
        </AnimatePresence>
