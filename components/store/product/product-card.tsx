...
const ProductCard = ({ product, viewMode = "grid" }: ProductCardProps) => {
  ...
  if (viewMode === "list") {
    return (
      <motion.div
        ...
        className="h-full"
      >
        <Card className="group overflow-hidden shadow-md hover:shadow-xl border bg-card transition-all duration-500">
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex-1 p-8 flex flex-col justify-between">
                <div className="space-y-4">
                  ...
                  >
                    <p className="text-sm tracking-wide text-primary font-medium">
                      {product.brand}
                    </p>
  ...
  return (
    ...
    >
      <Card className="group relative overflow-hidden shadow-md hover:shadow-xl border bg-card transition-all duration-500 h-full flex flex-col">
        <AspectRatio
          ratio={1}
        ...
        <CardContent className="p-6 space-y-4 flex-1 flex flex-col">
          ...
          >
            <div className="flex items-center gap-1">
              ...
              <span className="text-sm text-muted-foreground">
                {productAverageRating.toFixed(1)} ({product.reviews.length}{" "}
                Reviews)
              </span>
            </div>
          </motion.div>
