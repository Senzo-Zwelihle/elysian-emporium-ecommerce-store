  ...
  return (
    <>
      ...
      <AnimatePresence>
        {(isOpen || !isMobile) && (
          <motion.aside
            className="md:w-1/4 space-y-6 p-4 border rounded-lg shadow-sm md:block"
            variants={sidebarVariants}
            initial="hidden"
            animate="visible"
            exit="exit"
          >
            <h2 className="text-xl font-semibold pb-2 border-b">Filters</h2>
            <SearchFilter
              initialSearch={resolvedSearchParams.search as string | undefined}
            />
            <CategoryFilter
              initialCategory={
            ...
            />
            <SortFilter
              initialSortBy={resolvedSearchParams.sortBy as string | undefined}
            />
          </motion.aside>
        )}
      </AnimatePresence>
