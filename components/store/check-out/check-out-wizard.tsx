        ...
        return (
          <div className="space-y-4 lg:space-y-6">
            ...
            <div className="grid gap-4 lg:gap-6 lg:grid-cols-2">
              <Card className="p-4 lg:p-6 bg-muted/40 border">
                <h4 className="font-semibold mb-3 text-sm lg:text-base">Shipping Details</h4>
              ...
              <Card className="p-4 lg:p-6 bg-muted/40 border">
                <h4 className="font-semibold mb-3 text-sm lg:text-base">Payment Method</h4>
            ...
            {checkoutState.customerNotes && (
              <Card className="p-4 lg:p-6 bg-muted/40 border">
                <h4 className="font-semibold mb-3 text-sm lg:text-base">Customer Notes</h4>
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 sm:px-6">
      <div className="space-y-6 lg:space-y-8">
        ...
        <div className="bg-card border rounded-lg p-4 sm:p-6 lg:p-8 shadow-sm">
          {renderStepContent()}
        </div>
      </div>
