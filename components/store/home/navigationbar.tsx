...
import { redisShoppingCart } from "@/upstash/redis/db/cart";
              ...
              <Sheet>
                ...
                <SheetContent side="right">
                  ...
                  <div className="flex flex-col h-full">
                    {/* user avatar */}
                    {session?.user && (
                      <div className="flex items-center gap-3 px-3 rounded-lg mb-6">
                        <Avatar>
                          <AvatarImage
                            src={
                              session.user.image ||
                    ...
                    <nav className="flex flex-col gap-2 mb-6">
                      {mobileNavigationMenuItems.map((item, index) => (
                        <Link
                          key={index}
                          href={item.href}
                          className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-accent hover:text-accent-foreground transition-colors text-sm"
                        >
                          {item.title}
                        </Link>
                      ))}
                  ...
                  <>
                    ...
                    <div className="relative">
                      <Link href={"/account/favorites"}>
                        ...
                        >
                          <Badge className="bg-destructive size-5 px-1 rounded-full absolute top-0 right-0 translate-x-1 -translate-y-1">
                            {favoritesCount}
                          </Badge>
