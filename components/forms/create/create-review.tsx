...
import { reviewZodSchema } from "@/schemas/store/review";
import { createNewReviewAction } from "@/server/actions/store/review";

type ReviewFormValues = z.infer<typeof reviewZodSchema>;
...
const CreateNewReviewForm = ({
  ...
  const form = useForm<ReviewFormValues>({
    resolver: zodResolver(reviewZodSchema),
    defaultValues: {
    ...
    <AnimatePresence>
      {formVisible && (
        <motion.div
          ...
          className="relative  overflow-hidden rounded-3xl border border-border/50 bg-gradient-to-br from-card/80 to-card/60 backdrop-blur-sm p-6 shadow-xl"
        >
          ...
          <AnimatePresence>
            {showSuccess && (
              <motion.div
                ...
                className="absolute inset-0 z-20 flex items-center justify-center bg-gradient-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-sm rounded-3xl"
              >
          ...
          <div className="relative z-10">
            ...
            <Form {...form}>
              ...
              >
                    ...
                    <FormItem>
                      ...
                      >
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          What did you like or dislike? How did you use this
                          product?
                        </p>
                      </motion.div>
                      <FormControl>
                        ...
                        >
                          <Textarea
                            ...
                            className="min-h-[120px] resize-none rounded-2xl border-2 border-border/50 bg-background/50 backdrop-blur-sm transition-all duration-300 focus:border-primary/50 focus:ring-2 focus:ring-primary/20"
                            {...field}
                          />
                ...
                >
                  <p>
                    Your review will be visible to other customers after
                    moderation
                  </p>
                </motion.div>
              </form>
          ...
          {/* Bottom decoration */}
          <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-primary via-secondary to-primary opacity-50" />
        </motion.div>
      )}
    </AnimatePresence>
  );
...
export default CreateNewReviewForm;
